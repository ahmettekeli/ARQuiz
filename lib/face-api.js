(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getFaceExpressions(faceExpressions, minConfidence) {//Ahmet ekledi
        // console.log('param giris:',expr_Arr);
        let expr;
        if (minConfidence === void 0) { minConfidence = 0.1; }
        // console.log(1);
        var faceExpressionsArray = Array.isArray(faceExpressions) ? faceExpressions : [faceExpressions];
        ...
        faceExpressionsArray.forEach(function (e) {
            ...
            //var sorted = expr.asSortedArray();
            //var resultsToDisplay = sorted.filter(function (expr) { return expr.probability > minConfidence; });
            //expr_Arr = Object.entries(expr).map(([key, value]) => ({ key, value }));
            // console.log('emotion result', resultsToDisplay);
        });
        // console.log('expr arr', expr_Arr);
        return expr.asSortedArray();
    }
    ...
    var index$1 = /*#__PURE__*/Object.freeze({
        ...
        getFaceExpressions: getFaceExpressions, //Ahmet ekledi.
